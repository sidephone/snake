...
import com.sidephone.snake.engine.entities.food.Shoe
...
class Food {
	...
	private val foodTypes = listOf(Apple, Burger, Cake, Chicken, Egg, Fish, Mushroom, Pineapple, Pizza, Shoe, Watermelon)
